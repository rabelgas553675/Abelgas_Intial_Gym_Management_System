...
.hero{
  ...
  min-height:600px;      /* safety floor on tiny screens */
  display:flex;
  flex-direction:column;
  overflow:hidden;
}
...
.hero-image{
  position:absolute;
  inset:0;
  background-image:url("statue3.png");
...
.hero-overlay{
  ...
  background:
    linear-gradient(100deg,
      rgba(14,17,8,0.97) 0%,
      rgba(14,17,8,0.90) 28%,
      rgba(14,17,8,0.55) 52%,
      rgba(14,17,8,0.05) 100%
    ),
    linear-gradient(180deg,
      rgba(14,17,8,0.45) 0%,
      transparent 18%,
      transparent 72%,
      rgba(14,17,8,0.88) 100%
    );
}
...
nav{
  ...
  padding:20px 48px;
  flex-shrink:0;        /* never squash the nav */
}
...
.btn-nav-register{
  padding:10px 24px;background:#c8ff00;border:none;border-radius:8px;
  color:#111;font-family:'Barlow Condensed',sans-serif;
  font-size:14px;font-weight:800;letter-spacing:1px;
  cursor:pointer;transition:all 0.2s;text-transform:uppercase;
}
.btn-nav-register:hover{background:#b8ef00;transform:translateY(-1px);}

/* HERO CONTENT — fills remaining height, vertically centered */
.hero-content{
  position:relative;
  z-index:5;
  ...
  display:flex;
  flex-direction:column;
  justify-content:center;    /* vertical center within that space */
  padding:0 48px 48px;
  max-width:680px;
}

/* Title scales to fit — clamp keeps it readable on any screen */
.hero-title{
  font-family:'Barlow Condensed',sans-serif;
...
.feature-icon-box{
  ...
  border:1px solid rgba(200,255,0,0.35);border-radius:6px;
...
.btn-join{
  padding:16px 34px;background:#c8ff00;color:#111;border:none;border-radius:10px;
...
.diamond{
  width:28px;height:28px;background:#c8ff00;
  transform:rotate(45deg);border-radius:3px;
  animation:pulse-diamond 3s ease-in-out infinite;
}
.diamond-sm{
  width:18px;height:18px;background:rgba(200,255,0,0.4);
  transform:rotate(45deg);border-radius:2px;margin-left:-10px;
}
@keyframes pulse-diamond{
  0%,100%{opacity:1;transform:rotate(45deg) scale(1);}
  50%{opacity:0.7;transform:rotate(45deg) scale(0.9);}
}
@keyframes fadeUp{
...
.modal{
  ...
  position:relative;transform:translateY(20px) scale(0.97);transition:all 0.25s;
}
...
.modal-close{
  ...
  display:flex;align-items:center;justify-content:center;
  cursor:pointer;color:#666;font-size:18px;transition:all 0.15s;
}
...
.modal-tab{
  ...
  cursor:pointer;border-radius:7px;color:#555;transition:all 0.15s;border:none;background:transparent;
}
...
.fm-label{display:block;font-size:11px;font-weight:500;color:#555;margin-bottom:5px;letter-spacing:1px;text-transform:uppercase;}
.fm-input{
  width:100%;padding:11px 14px;background:#1a1a1a;
  border:1px solid rgba(255,255,255,0.08);border-radius:10px;
  color:#fff;font-family:'DM Sans',sans-serif;font-size:14px;outline:none;transition:border-color 0.15s;
}
.fm-input:focus{border-color:#c8ff00;}
.fm-row{display:grid;grid-template-columns:1fr 1fr;gap:10px;}

.btn-submit{
  width:100%;padding:14px;background:#c8ff00;color:#111;
  font-family:'Barlow Condensed',sans-serif;font-size:16px;font-weight:900;
  letter-spacing:3px;text-transform:uppercase;border:none;border-radius:10px;
...
.feat-card{background:#0e1108;padding:36px 32px;border-top:2px solid transparent;transition:all 0.3s;position:relative;overflow:hidden;}
...
<section class="hero">
  ...
  <nav>
    ...
    <div class="nav-center">
      ...
      <span class="nav-center-text">Gym Management System</span>
    </div>
  ...
  <div class="hero-content">
    ...
    <div class="hero-features">
      ...
      <div class="hero-feature">
        ...
        <div class="feature-divider"></div>
        <span class="feature-text">Full Dashboard</span>
      </div>
      <div class="hero-feature">
        <div class="feature-icon-box">
          <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="feature-divider"></div>
        <span class="feature-text">Member Mgmt</span>
      </div>
    </div>

    <div class="hero-cta">
      <button class="btn-join" onclick="openModal('register')">JOIN NOW</button>
      <button class="btn-login-hero" onclick="openModal('login')">
        LOGIN
...
<section class="section section-mid" id="features">
  <div class="reveal">
    <div class="section-eyebrow">Why IRONFORGE</div>
    <div class="section-title">EVERYTHING YOU NEED</div>
  </div>
  <div class="features-grid reveal">
    <div class="feat-card">
      <div class="feat-icon-wrap">
        <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
      </div>
      <div class="feat-title">Member Management</div>
      <p class="feat-desc">Complete CRUD with photo upload, personal info, membership plans, and auto end-date calculation.</p>
    </div>
    <div class="feat-card">
      <div class="feat-icon-wrap">
        <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
      </div>
      <div class="feat-title">Payment Tracking</div>
      <p class="feat-desc">Record payments via Cash, GCash, or Bank Transfer. Track monthly and total revenue in real time.</p>
    </div>
    <div class="feat-card">
      <div class="feat-icon-wrap">
        <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
      </div>
      <div class="feat-title">Role-Based Access</div>
      <p class="feat-desc">Admin, Staff, and User roles — each seeing only what they need. Built with Laravel middleware.</p>
    </div>
    <div class="feat-card">
      <div class="feat-icon-wrap">
        <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
      </div>
      <div class="feat-title">Membership Plans</div>
      <p class="feat-desc">Monthly, Quarterly, Semi-Annual and Annual plans with auto-computed fees and due dates.</p>
    </div>
    <div class="feat-card">
      <div class="feat-icon-wrap">
        <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
      </div>
      <div class="feat-title">Live Dashboard</div>
      <p class="feat-desc">Real-time stats: active members, expired accounts, revenue this month, and recent registrations.</p>
    </div>
    <div class="feat-card">
      <div class="feat-icon-wrap">
        <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
      </div>
      <div class="feat-title">Laravel Breeze Auth</div>
      <p class="feat-desc">Secure authentication with protected routes, session handling, and role-based redirects.</p>
    </div>
  </div>
</section>
...
<section class="section section-dark" id="plans">
  <div class="reveal">
    <div class="section-eyebrow">Membership Tiers</div>
  ...
  <div class="plans-grid reveal">
    <div class="plan-card">
      ...
      <div class="plan-dur">/ 30 days</div>
      <ul class="plan-feats">
      ...
      <button class="btn-plan btn-plan-ghost" onclick="openModal('register')">Get Started</button>
    </div>
    <div class="plan-card hot">
      <div class="plan-hot-badge">Most Popular</div>
      <div class="plan-label">Quarterly</div>
      <div class="plan-price" style="color:#c8ff00;">₱2,100</div>
      <div class="plan-dur">/ 90 days</div>
      <ul class="plan-feats">
        <li>Full gym access</li>
        <li>Locker included</li>
      ...
      <button class="btn-plan btn-plan-solid" onclick="openModal('register')">Get Started</button>
    </div>
    <div class="plan-card">
      <div class="plan-label">Annual</div>
      <div class="plan-price">₱7,500</div>
      <div class="plan-dur">/ 365 days</div>
      <ul class="plan-feats">
        <li>Full gym access</li>
        <li>Locker included</li>
  ...
  <div class="modal">
    ...
    <div class="modal-logo-row">
      <div class="modal-logo-icon">
        <svg fill="none" stroke="#111" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
      </div>
    ...
    <div class="form-panel active" id="panel-login">
      ...
      <form method="POST" action="/login">
        ...
        <div class="fm-group">
          ...
          <input type="email" name="email" class="fm-input" placeholder="admin@gym.com" required/>
        </div>
        <div class="fm-group">
    ...
    <div class="form-panel" id="panel-register">
      ...
      <form method="POST" action="/register">
        ...
        <div class="fm-group">
          ...
          <input type="text" name="name" class="fm-input" placeholder="Juan Dela Cruz" required/>
        </div>
        <div class="fm-group">
          <label class="fm-label">Email</label>
          <input type="email" name="email" class="fm-input" placeholder="juan@email.com" required/>
        </div>
        <div class="fm-row">
          <div class="fm-group">
            <label class="fm-label">Password</label>
