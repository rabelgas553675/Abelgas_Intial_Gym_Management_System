...
<style>
  ...
  select.profile-select option {
    background-color: #1a1a1a; /* Matches your surface color */
    color: white;
  }
</style>
  ...
  <div style="background:var(--surface);border:1px solid var(--border);border-radius:16px;
    ...
    <div style="position:relative;display:inline-block;margin-bottom:20px;">
      ...
      <label style="position:absolute;bottom:6px;right:6px;width:34px;height:34px;border-radius:50%;
                     ...
                     cursor:pointer;border:3px solid var(--bg);box-shadow:0 2px 8px rgba(0,0,0,0.4);">
  ...
  <div style="background:var(--surface);border:1px solid var(--border);border-radius:16px;padding:32px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;margin-bottom:36px;">
      <div>
        ...
        <div style="font-size:15px;font-weight:600;color:var(--warning);padding:8px 0;
      ...
      <div>
        ...
        <div style="font-size:15px;font-weight:600;padding:8px 0;border-bottom:1px solid var(--border);
                    color:var(--muted);">
    ...
    <div style="display:flex;justify-content:flex-end;gap:12px;">
      <a href="{{ route('staff.dashboard') }}" class="btn btn-secondary" style="padding:11px 28px; background:transparent; border:1px solid var(--border); color:white; text-decoration:none; border-radius:8px; font-size:14px;">
        Cancel
      </a>
